...
const file_order_v1_order_proto_rawDesc = "" +
	...
	"\x06status\x18\x04 \x01(\x0e2\x15.order.v1.OrderStatusR\x06status\"b\n" +
	"\x12CreateOrderRequest\x12)\n" +
	"\x05items\x18\x01 \x03(\v2\x13.order.v1.OrderItemR\x05items\x12!\n" +
	"\ftotal_amount\x18\x02 \x01(\x01R\vtotalAmount\"_\n" +
	...
	"\x15ORDER_STATUS_REJECTED\x10\x032\x9d\x01\n" +
	"\fOrderService\x12J\n" +
	"\vCreateOrder\x12\x1c.order.v1.CreateOrderRequest\x1a\x1d.order.v1.CreateOrderResponse\x12A\n" +
	"\bGetOrder\x12\x19.order.v1.GetOrderRequest\x1a\x1a.order.v1.GetOrderResponseB>Z<github.com/pavelmaksimov25/go-oms/pkg/proto/order/v1;orderv1b\x06proto3"
